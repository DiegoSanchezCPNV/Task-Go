...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-75">
            <input type="text" id="fmail" name="fmail" placeholder="Veuillez entrer votre adresse mail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Exemple : prenom.nom@cpnv.ch" required>
        </div>
    </div>
    <div class="row">
        <div class="col-25">
        ...
        <div class="col-75">
            <input type="text" id="fmail2" name="fmail2" placeholder="Veuillez confirmer votre adresse mail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Exemple : prenom.nom@cpnv.ch" required>
        </div>
    </div>
    <div class="row">
        <div class="col-25">
